...
export const appDescription =
  "dlabs offers comprehensive web3 solutions, from smart contract development, to security audits, to dApp design. Elevate your protocol with our end-to-end blockchain services."
